...
VCROOT     = C:\Program Files\Microsoft Visual Studio 10.0\VC
WINSDKROOT = C:\Program Files\Microsoft SDKs\Windows\v7.0A
MATLABROOT = C:\Program Files\MATLAB\R2010a
...
MEXEXT     = mexw32
MEXOPT     = $(MATLABROOT)\bin\win32\mexopts\msvc100opts.bat
...
!IFDEF MATLABROOT
all: $(bindir) $(objdir) $(mexdir) $(bindir)\vl.lib $(bindir)\vl.dll $(mexdir)\vl.dll $(cmdexe) $(mexdll)
!ELSE
#all: $(bindir) $(objdir) $(bindir)\vl.lib $(bindir)\vl.dll $(cmdexe)
all: $(bindir) $(objdir) $(bindir)\vl.lib $(bindir)\vl.dll $(cmdexe)
!ENDIF
